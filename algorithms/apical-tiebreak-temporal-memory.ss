...
(define attm-defaults `(                 ;; (Listof KWarg) [cf __init__ in attm.py]
    ...
    [calc-predicted-cells                  . #f]
                                                                                            ...
                                                                                            ;
(define-record-type tm (fields           ;; TM [Layer: Temporal Memory parameters]
    column-count                         ;; Nat
